...
public class DRTabTextView extends RelativeLayout {
    private TextView tab_button;
    private View view_line;
    private boolean isChecked = false;

    public DRTabTextView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        initLayout(context, attrs);
    }

    public DRTabTextView(Context context) {
        super(context);
    }

    public DRTabTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initLayout(context, attrs);
    }
