...
public class DRTabButton extends RelativeLayout {
	...
	public DRTabButton(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		initLayout(context, attrs);
	}

	public DRTabButton(Context context) {
		super(context);
	}

	public DRTabButton(Context context, AttributeSet attrs) {
		super(context, attrs);
		initLayout(context, attrs);
	}
